...
import { type TabsVariantProps, tabs } from '@shadowrz/hanekokoro-ui/styled-system/recipes';
...
export const Trigger = asChild(withContext<Assign<HTMLStyledProps<'button'>, Tabs.TriggerBaseProps>>(Tabs.Trigger, 'trigger'));

...
import { type FieldVariantProps, field, input, textarea } from '@shadowrz/hanekokoro-ui/styled-system/recipes';
...
export const Root = withProvider<Assign<Assign<HTMLStyledProps<'div'>, Field.RootBaseProps>, FieldVariantProps>>(
  Field.Root,
  'root'
);
...
export const Label = withContext<Assign<HTMLStyledProps<'label'>, Field.LabelBaseProps>>(Field.Label, 'label');

export const Select = withContext<Assign<HTMLStyledProps<'select'>, Field.SelectBaseProps>>(Field.Select, 'select');

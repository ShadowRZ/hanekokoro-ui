...
import { type PopoverVariantProps, popover } from '@shadowrz/hanekokoro-ui/styled-system/recipes';
...
export const Anchor = withContext<Assign<HTMLStyledProps<'div'>, Popover.AnchorBaseProps>>(Popover.Anchor, 'anchor');

export const Arrow = withContext<Assign<HTMLStyledProps<'div'>, Popover.ArrowBaseProps>>(Popover.Arrow, 'arrow');
...
export const CloseTrigger = withContext<Assign<HTMLStyledProps<'button'>, Popover.CloseTriggerBaseProps>>(
...
export const Description = withContext<Assign<HTMLStyledProps<'div'>, Popover.DescriptionBaseProps>>(
  Popover.Description,
  'description'
);
...
export const Title = withContext<Assign<HTMLStyledProps<'div'>, Popover.TitleBaseProps>>(Popover.Title, 'title');

export const Trigger = asChild(
  withContext<Assign<HTMLStyledProps<'button'>, Popover.TriggerBaseProps>>(Popover.Trigger, 'trigger')
);

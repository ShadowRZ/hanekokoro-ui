...
import { type CheckboxVariantProps, checkbox } from '@shadowrz/hanekokoro-ui/styled-system/recipes';
...
export const Group = withContext<Assign<HTMLStyledProps<'div'>, Checkbox.GroupBaseProps>>(Checkbox.Group, 'group');
...
export const Label = withContext<Assign<HTMLStyledProps<'span'>, Checkbox.LabelBaseProps>>(Checkbox.Label, 'label');

...
export const Root = withRootProvider<Assign<DropdownMenu.DropdownMenuRootProps, MenuVariantProps>>(DropdownMenu.Root);
...
) => JSX.Element = withContext(DropdownMenu.ItemLabel, 'itemText');
